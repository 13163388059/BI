...
function init(myChart) {
  const option = {
    ...
    legend: {
      orient: "vertical",
      left: "left",
      data: ["鄂A55555", "鄂A56789", "鄂A66666", "鄂A88888", "鄂A47895"]
    },
    series: [
      {
        name: "费用",
        type: "pie",
        data: [
          { value: 5500, name: "鄂A55555" },
          { value: 6000, name: "鄂A56789" },
          { value: 8000, name: "鄂A66666" },
          { value: 8500, name: "鄂A88888" },
          { value: 7000, name: "鄂A47895" }
        ],
        itemStyle: {
          emphasis: {
            shadowBlur: 10,
